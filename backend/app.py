...
superkart_api = Flask("superkart_sales_forecast_app") #Complete the code to define the name of the app
...
@superkart_api.get('/')
def home():
    return "Welcome to SuperKart Sales Forecast API!" #Complete the code to define a welcome message
